# Native World Radar 2.3.0 - Nexus Publishing Index
...
- `NEXUS_CHANGELOG.txt`: plain-text changelog; select the 2.3.0 section.
...
Use 2.3.0 in the Nexus version field. Existing screenshots and artwork may
