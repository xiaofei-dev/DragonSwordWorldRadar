-- Stable UE4SS module name for the generated world-boss dataset.
-- The installer writes data/generated/bosses.lua from the local game PAK.
local source = debug.getinfo(1, "S").source
if type(source) ~= "string" or string.sub(source, 1, 1) ~= "@" then
    error("DragonSwordWorldRadar could not resolve the boss dataset path")
end
...
return dofile(mod_directory .. "\\data\\generated\\bosses.lua")
