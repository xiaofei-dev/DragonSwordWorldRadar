...
logPath = fso.BuildPath(logDir, "DragonSwordWorldRadarObjectState.Watcher.log")
...
LogLine "WATCHER_START version=0.5.0-dev2-native-presence host=wscript pidless=true"
Do
