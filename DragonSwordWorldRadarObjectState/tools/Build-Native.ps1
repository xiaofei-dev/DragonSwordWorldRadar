...
$sdkRoot = Join-Path (Split-Path -Parent $projectRoot) `
    'DragonSwordNativeAutoPickup\.sdk'
...
try {
    ...
    & $cmake --build $buildDirectory --target DragonSwordWorldRadarObjectState
