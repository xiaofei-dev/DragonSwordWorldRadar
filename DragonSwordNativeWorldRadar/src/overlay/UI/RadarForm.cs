    ...
    internal sealed class RadarForm : Form
    {
        ...
        public RadarForm()
        {
            ...
            _trayIcon = new NotifyIcon
            {
                ...
                Text = "DragonSwordNativeWorldRadar",
        ...
        private ContextMenuStrip CreateTrayMenu()
        {
            ...
            ToolStripMenuItem exitItem = new ToolStripMenuItem(
                "Exit DragonSwordNativeWorldRadar");
        ...
        private void CheckGameLifetime()
        {
            ...
            {
                ErrorLog.WriteDebug(
                    "mods.txt disabled DragonSwordNativeWorldRadar; closing overlay.");
                Close();
                return;
            }
            ...
            ErrorLog.WriteDebug(
                "Game process exited; closing DragonSwordNativeWorldRadar overlay.");
            Close();
        }
