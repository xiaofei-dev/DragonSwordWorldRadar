...
try {
    ...
    $ownsMutex = $true
    Log "START version=0.4.0-dev9-performance1.8-singlebridge1 renderer=WinForms pid=$PID host=single_process_watcher"
...
'@
    ...
    [IO.File]::WriteAllText(
        ...
        '0.4.0-dev9-performance1.8-singlebridge1 WinForms',
